package com.keyan.project.system.post.domain;
...
public class Post extends BaseEntity
{
    ...
    /** 岗位序号 */
    @Excel(name = "岗位序号", column = "A")
    private Long postId;

    /** 岗位编码 */
    @Excel(name = "岗位编码", column = "B")
    private String postCode;

    /** 岗位名称 */
    @Excel(name = "岗位名称", column = "C")
    private String postName;

    /** 岗位排序 */
    @Excel(name = "岗位排序", column = "D")
    private String postSort;

    /** 状态（0正常 1停用） */
    @Excel(name = "状态", column = "E")
